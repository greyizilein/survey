...
CREATE INDEX IF NOT EXISTS enterprise_members_enterprise_idx ON public.enterprise_members(enterprise_id);
CREATE INDEX IF NOT EXISTS enterprise_members_user_idx ON public.enterprise_members(user_id);
CREATE INDEX IF NOT EXISTS enterprise_members_email_idx ON public.enterprise_members(email);
...
DROP POLICY IF EXISTS "Enterprise members view own row" ON public.enterprise_members;
...
DROP POLICY IF EXISTS "Anyone can submit enterprise request" ON public.enterprise_requests;
