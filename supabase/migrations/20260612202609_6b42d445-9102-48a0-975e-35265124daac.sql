...
ALTER TABLE public.personas ADD COLUMN IF NOT EXISTS population_id UUID REFERENCES public.populations(id) ON DELETE CASCADE;
CREATE INDEX IF NOT EXISTS personas_population_idx ON public.personas(population_id);